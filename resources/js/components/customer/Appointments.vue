                    ...
                    if(data.appointments && data.appointments.length > 0) {
                        ...
                        this.events.forEach((item) => {
                            this.eventsForCalender.push({
                                ...
                                description: `<div class="mt-2"><p class="mb-1"><b>Usluga:</b> ${item.pivot.service_name}</p><p class="mb-1"><b>Poruka:</b> ${item.pivot.message}</p><p class="mb-1"><b>Vrijeme:</b> ${item.pivot.time}</p></div>`,
                                icon: "",
